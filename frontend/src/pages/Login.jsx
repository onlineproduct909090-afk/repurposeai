...
// ✅ Naya AuthContext (Real Supabase)
    ...
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Sign in to continue repurposing.</p>
        </div>
        ...
        <div className="flex flex-col items-center gap-3 mt-6 text-xs text-slate-400">
          ...
          <button
            ...
            className="hover:text-slate-200 transition-colors underline decoration-dotted"
          >
            {useMagicLink ? "Use password instead" : "Sign in with magic link (no password)"}
          </button>
          <p>
